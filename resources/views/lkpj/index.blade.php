        ...
        <div class="portlet-title">
            ...
            <div class="actions" style="margin-top:-40px">
                <div class="pull-right">
                    <a style="margin-left:20px" class="btn btn-info" href="{{ route('lkpj.print') }}"><i class="fa fa-print"></i> Cetak</a>
                </div>
                <div class="pull-right">
            ...
            <table class="table table-bordered table-hover" id="myTable">
                <thead>
                    <tr style="background-color:#f3f3f3;">
                        ...
                        <th width="180px" onclick="sortTable(5)" class="text-center">Anggaran</th>
                        <th width="180px" onclick="sortTable(5)" class="text-center">Realisasi</th>
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="text-center bold">Tidak Ada Data Ditemukan</td>
                        </tr>
                    @endforelse
