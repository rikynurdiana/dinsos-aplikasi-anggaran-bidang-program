...
@section('tab-title')
    <title>EDIT PMKS | DINSOS KBB</title>
@endsection
...
@section('page-content')
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject font-green bold uppercase">Edit Kategori PMKS</span>
            </div>
        </div>
        <div class="portlet-body">
            ...
            @endif
            {!! Form::model($masters, ['method' => 'PATCH','route' => ['kategori-pmks.update', $masters->id], 'enctype' => 'multipart/form-data', 'files' => 'true']) !!}
                @include('kategori.form-edit')
            {!! Form::close() !!}
        </div>
    </div>
@endsection
