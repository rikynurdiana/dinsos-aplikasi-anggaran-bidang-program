        ...
        <div class="portlet-title">
            ...
            <div class="actions" style="margin-top:-40px">
                <div class="pull-right">
                    <a style="margin-left:20px" class="btn btn-info" href="{{ route('kategori-pmks.print') }}"><i class="fa fa-print"></i> Cetak</a>
                </div>
                <div class="pull-right">
            ...
            <table class="table table-bordered table-hover" id="myTable">
                <thead>
                    <tr style="background-color:#f3f3f3;">
                        ...
                        <th width="200px" onclick="sortTable(3)" class="text-center">Jumlah Keseluruhan</th>
                        <th width="200px" onclick="sortTable(4)" class="text-center">Sudah Ditangani</th>
                        <th width="200px" onclick="sortTable(5)" class="text-center">Belum Ditangani</th>
                ...
                <tbody>
                    @forelse ($masters as $master)
                        <tr>
                            ...
                            <td class="text-right">
                                {{ $master->sudah_ditangani ? number_format($master->sudah_ditangani) : 0 }} Orang
                            </td>
                            <td class="text-right">
                                {{ $master->belum_ditangani ? number_format($master->belum_ditangani) : 0 }} Orang
                            </td>
